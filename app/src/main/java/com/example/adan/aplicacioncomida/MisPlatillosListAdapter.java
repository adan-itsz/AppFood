...
public class MisPlatillosListAdapter extends ArrayAdapter<String> {
    ...
    public MisPlatillosListAdapter(Activity context, String[] itemname,String[] cocineroname,String[] fechacompra,String[] preciocompra, Integer[] integers) {
    ...
    public View getView(int posicion, View view, ViewGroup parent){
        ...
        txtFecha.setText("Fecha de publicacion : "+fechacompra[posicion]);
