...
public class ActivityVentas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VentasListAdapter adapter = new VentasListAdapter(this, NombrePlatillo, NombreCocinero, FechaCompra, PrecioCompra, imgid);
        lista = (ListView) findViewById(R.id.listVentas);
